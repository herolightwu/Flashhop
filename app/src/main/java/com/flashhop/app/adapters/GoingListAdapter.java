...
public class GoingListAdapter extends RecyclerView.Adapter<GoingListAdapter.ViewHolder> {
     ...
     */
    public GoingListAdapter(List<EventModel> dataSet, Context context) {
        mDataSet = dataSet;
        mContext = context;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        viewHolder.tv_time.setText(one.time.toUpperCase());
