package com.flashhop.app.libraries;
...
public class ColorArcProgressBar extends View{
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        startAngle = a.getInteger(R.styleable.ColorArcProgressBar_start_angle, 135);
    ...
    public void setTotalAngle(int tAngle){
        this.sweepAngle = tAngle;
    }
    ...
    public void setColors(int nColor){
        this.colors = new int[]{nColor, nColor, nColor, nColor};
    }
